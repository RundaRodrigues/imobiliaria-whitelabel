# Imobiliaria — modelo white label

Modelo white label para imobiliarias boutique. Editorial, tipografia serifada, muito respiro.
...
**Secoes da pagina:** hero full-bleed com busca, portfolio de imoveis, bairros, diferenciais, numeros, corretores, depoimentos, FAQ, avaliacao.
...
Sistema de design adaptado (nao copiado) de **apple**, via
