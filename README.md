# Imobiliária — modelo white label

Modelo white label para imobiliárias boutique. Editorial, tipografia serifada, muito respiro.
...
**Seções da página:** hero de largura total com busca, portfólio de imóveis, bairros, diferenciais, números, corretores, depoimentos, dúvidas e avaliação.
...
Sistema de design adaptado (não copiado) de **apple**, via
